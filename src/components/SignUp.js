...
const SignUp = () => {
	const { handleChange, handleSubmit, formValues, formErrors, setFormErrors } = useForm(submit, signupValidator);
				...
				<form onSubmit={handleSubmit} className="form signup-form" noValidate>
					...
					<div className="form-group">
						<input
							...
							name="password"
							onChange={handleChange}
							className={`signup-form__password ${formErrors.password && 'invalid'}`}
						...
						<input
							...
							onChange={handleChange}
							className={`signup-form__passwordconfirm ${formErrors.confirmPassword && 'invalid'}`}
					...
					<span className="password-tip">Password must be at least 8 characters long.</span>
