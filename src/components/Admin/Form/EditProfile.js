...
const EditUser = props => {
  const {
    ...
    formErrors,
    setFormErrors
  } = useForm(submitEdit, editUserValidator);
        ...
        <form onSubmit={handleSubmit} className="form user-form">
          ...
          <div className="form-group">
            <input
              ...
              className={`edit-user__company ${formErrors.company &&
                "invalid"}`}
              onChange={handleChange}
          ...
          <div className="errors-container">
            {formErrors.company && (
              <span className="help inavild">{formErrors.company}</span>
            )}
          </div>
          <div className="form-group">
            <input
          ...
          <div className="form-group">
            <input
              ...
              className={`edit-user__password ${formErrors.password &&
                "invalid"}`}
              onChange={handleChange}
          ...
          <div className="form-group">
            ...
            <input
              ...
              className={`edit-user__newPassword ${formErrors.newPassword &&
                "invalid"}`}
              onChange={handleChange}
          ...
          <div className="errors-container">
            {formErrors.newPassword && (
              <span className="help inavild">{formErrors.newPassword}</span>
            )}
          </div>
          <div className="form-group">
            <input
              ...
              className={`edit-user__confirmNewPassword ${formErrors.confirmNewPassword &&
                "invalid"}`}
              onChange={handleChange}
