    ...
    try {
      ...
      if (data.employee) {
        ...
        setTimeout(() => {
          ...
          data.workWeek.map(
            day => (tempHours = parseFloat(day.shift_hours) + tempHours)
          );
          data.workWeek.map(
            day => (tempWage = parseFloat(day.shift_wage) + tempWage)
          );
      ...
      <div className="employee-details__shifts">
        <div className="details-shifts__group">
          <div className="details-shifts__cell">
            <span className="details-shifts__cell--title">
              Current week hours:
            </span>
          </div>
          <div className="details-shifts__cell">
        ...
        <div className="details-shifts__group">
          ...
          <div className="details-shifts__cell">
            <span className="details-shifts__cell--wage">
              &#163; {weekWage}
            </span>
          </div>
        </div>
